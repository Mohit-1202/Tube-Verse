...
export default function Your_Channel_Page() {
 ...
 useEffect(() => {
  if (user?.username) {
    ...
    getChannelStats(user.username);
  } else {
    console.log("Username not found, skipping stats fetch.");
  }
}, [user]);
      ...
      <div className="px-4 py-6 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 -mt-16">
          ...
          <div className="flex flex-col justify-center text-center sm:text-left">
            ...
            <p className="text-lg text-gray-300 mb-3 mt-1">{user?.email || "email not provided"}</p>
        ...
        {channelStats ? (
            ...
            {[
              {
                ...
                value: channelStats.totalSubs || 0,
              },
              {
                icon: faVideo,
                label: "Total Videos",
              ...
              {
                icon: faHeart,
                label: "Total Liked Videos",
                value: channelStats.totalVideoLikes || 0,
              },
              {
                icon: faEye,
                label: "Total Views",
              ...
              },
              {
                icon: faComment,
                label: "Total Tweets",
                value: channelStats.totalTweets || 0,
              },
              {
                icon: faHeart,
                label: "Liked Tweets",
                value: channelStats.totalTweetLikes || 0,
              },
              {
                icon: faComment,
                label: "Total Comments",
                value: channelStats.totalComments || 0,
              },
              {
                icon: faHeart,
                label: "Liked Comments",
                value: channelStats.totalCommentLikes || 0,
              },
              {
                icon: faCalendar,
                label: "Joined On",
              ...
              <div
                key={index}
                className="bg-[#2c2c2c] p-4 rounded-lg hover:bg-[#333] transition-colors"
              >
          ...
          <div className="text-center text-gray-400">Loading channel analytics...</div>
        )}
      </div>
    </div>
  );

  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#1e1e1e] px-4">
      ...
      <div className="flex items-center justify-center mb-6 ">
                <FontAwesomeIcon className="start:text-[25px] mobile-s:text-[30px] mini:text-[54px] text-[#FF9200]" icon={faCirclePlay} />
                <h1 className={`text-white start:-mt-[2px] start:text-[25px] mini:text-[54px] ml-2`}>Welcome To TubeVerse</h1>
            </div>
